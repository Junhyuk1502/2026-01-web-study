...
- 학생별 작업물은 반드시 본인 GitHub 아이디 폴더 아래에 정리합니다.
...
## 과제 제출 방법
1. 이 레포를 `clone` 합니다.
2. 본인 폴더를 `projects/<github-id>/` 형태로 만듭니다.
3. 주차별 과제는 `projects/<github-id>/week1`, `projects/<github-id>/week2`처럼 정리합니다.
4. 작업 후 변경 사항을 커밋하고 푸시합니다.
5. 운영 방식에 따라 직접 `push`하거나 `Pull Request`로 제출합니다.
